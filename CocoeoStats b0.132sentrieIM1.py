...
ENDPOINTS = {
    'profile': 'http://135.181.19.50:5001/get_profile?account=%s',
    'validators': 'http://135.181.19.50:5001/get_all_validators',
    'validator_delegations': 'http://135.181.19.50:5001/staking/validators/%s/delegations'
}
TESTING = False
THREADS = 8
