...
# http://85.214.91.220:5001
# Constants
# ------------------------------------------------------------------------------
CSV_FILE = 'delegations.csv'
ENDPOINTS = {
    'profile': 'http://tradescan.switcheo.org/get_profile?account=%s',
    'validators': 'http://tradescan.switcheo.org/get_all_validators',
    'validator_delegations': 'http://tradescan.switcheo.org/staking/validators/%s/delegations'
}
TESTING = False
THREADS = 8
...
# Supress blank lines on CSV....
# ------------------------------------------------------------------------------
file_object = open('delegations.csv', 'r', encoding='utf-8')
...
if flag ==1: #if blank line is present in file
    file_object = open('delegations.csv', 'w', encoding='utf-8')
    for line in data:
        str1 = ','.join(line)
