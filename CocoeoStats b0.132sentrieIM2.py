...
ENDPOINTS = {
    'profile': 'http://213.133.110.57:5001/get_profile?account=%s',
    'validators': 'http://213.133.110.57:5001/get_all_validators',
    'validator_delegations': 'http://213.133.110.57:5001/staking/validators/%s/delegations'
}
TESTING = False
THREADS = 8
