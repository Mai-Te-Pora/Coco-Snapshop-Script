...
ENDPOINTS = {
    'profile': 'http://144.76.86.163:5001/get_profile?account=%s',
    'validators': 'http://144.76.86.163:5001/get_all_validators',
    'validator_delegations': 'http://144.76.86.163:5001/staking/validators/%s/delegations'
}
TESTING = False
THREADS = 8
